...
func (b *ContainerApplyConfiguration) WithResourcesAllocated(value corev1.ResourceList) *ContainerApplyConfiguration {
...
func (b *ContainerApplyConfiguration) WithResizePolicy(values ...*ResizePolicyApplyConfiguration) *ContainerApplyConfiguration {
	for i := range values {
		if values[i] == nil {
